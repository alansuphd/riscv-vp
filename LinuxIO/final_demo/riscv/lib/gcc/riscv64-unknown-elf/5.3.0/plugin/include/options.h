...
enum opt_code
{
  ...
  OPT_mbranch_cost_ = 1140,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1141,                       /* -mcmodel= */
  OPT_mfdiv = 1142,                          /* -mfdiv */
  OPT_mhard_float = 1143,                    /* -mhard-float */
  OPT_mmemcpy = 1144,                        /* -mmemcpy */
  OPT_mmuldiv = 1145,                        /* -mmuldiv */
  OPT_mno_fdiv = 1146,                       /* -mno-fdiv */
  OPT_mplt = 1147,                           /* -mplt */
  OPT_mrvc = 1148,                           /* -mrvc */
  OPT_msave_restore = 1149,                  /* -msave-restore */
  OPT_msmall_data_limit_ = 1150,             /* -msmall-data-limit= */
  OPT_msoft_float = 1151,                    /* -msoft-float */
  OPT_mtune_ = 1152,                         /* -mtune= */
  OPT_n = 1153,                              /* -n */
  ...
  OPT_quiet = 1181,                          /* -quiet */
  OPT_r = 1182,                              /* -r */
  OPT_remap = 1183,                          /* -remap */
  OPT_s = 1184,                              /* -s */
  OPT_s_bc_abi = 1185,                       /* -s-bc-abi */
  OPT_save_temps = 1186,                     /* -save-temps */
  OPT_save_temps_ = 1187,                    /* -save-temps= */
  OPT_shared = 1188,                         /* -shared */
  OPT_shared_libgcc = 1189,                  /* -shared-libgcc */
  /* OPT_specs = 1190, */                    /* -specs */
  OPT_specs_ = 1191,                         /* -specs= */
  OPT_static = 1192,                         /* -static */
  OPT_static_libasan = 1193,                 /* -static-libasan */
  OPT_static_libgcc = 1194,                  /* -static-libgcc */
  OPT_static_libgcj = 1195,                  /* -static-libgcj */
  OPT_static_libgfortran = 1196,             /* -static-libgfortran */
  OPT_static_libgo = 1197,                   /* -static-libgo */
  OPT_static_liblsan = 1198,                 /* -static-liblsan */
  OPT_static_libmpx = 1199,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1200,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1201,               /* -static-libstdc++ */
  OPT_static_libtsan = 1202,                 /* -static-libtsan */
  OPT_static_libubsan = 1203,                /* -static-libubsan */
  /* OPT_std_c__03 = 1204, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1205, */                /* -std=c++0x */
  OPT_std_c__11 = 1206,                      /* -std=c++11 */
  OPT_std_c__14 = 1207,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1208, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1209, */                /* -std=c++1y */
  OPT_std_c__1z = 1210,                      /* -std=c++1z */
  OPT_std_c__98 = 1211,                      /* -std=c++98 */
  OPT_std_c11 = 1212,                        /* -std=c11 */
  /* OPT_std_c1x = 1213, */                  /* -std=c1x */
  /* OPT_std_c89 = 1214, */                  /* -std=c89 */
  OPT_std_c90 = 1215,                        /* -std=c90 */
  OPT_std_c99 = 1216,                        /* -std=c99 */
  /* OPT_std_c9x = 1217, */                  /* -std=c9x */
  OPT_std_f2003 = 1218,                      /* -std=f2003 */
  OPT_std_f2008 = 1219,                      /* -std=f2008 */
  OPT_std_f2008ts = 1220,                    /* -std=f2008ts */
  OPT_std_f95 = 1221,                        /* -std=f95 */
  OPT_std_gnu = 1222,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1223, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1224, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1225,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1226,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1227, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1228, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1229,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1230,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1231,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1232, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1233, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1234,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1235,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1236, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1237, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1238,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1239, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1240, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1241, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1242,                     /* -std=legacy */
  OPT_symbolic = 1243,                       /* -symbolic */
  OPT_t = 1244,                              /* -t */
  OPT_time = 1245,                           /* -time */
  OPT_time_ = 1246,                          /* -time= */
