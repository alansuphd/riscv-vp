...
#define HAVE_mulsi3_highpart (TARGET_MULDIV && !TARGET_64BIT)
#define HAVE_umulsi3_highpart (TARGET_MULDIV && !TARGET_64BIT)
#define HAVE_usmulsi3_highpart (TARGET_MULDIV && !TARGET_64BIT)
#define HAVE_divsi3 (TARGET_MULDIV)
#define HAVE_udivsi3 (TARGET_MULDIV)
#define HAVE_divdi3 (TARGET_MULDIV && TARGET_64BIT)
#define HAVE_udivdi3 (TARGET_MULDIV && TARGET_64BIT)
#define HAVE_modsi3 (TARGET_MULDIV)
#define HAVE_umodsi3 (TARGET_MULDIV)
...
#define HAVE_mulsi3 (TARGET_MULDIV)
#define HAVE_muldi3 ((TARGET_MULDIV) && (TARGET_64BIT))
#define HAVE_mulsidi3 (TARGET_MULDIV && !TARGET_64BIT)
#define HAVE_umulsidi3 (TARGET_MULDIV && !TARGET_64BIT)
#define HAVE_usmulsidi3 (TARGET_MULDIV && !TARGET_64BIT)
#define HAVE_movdi 1
#define HAVE_movsi 1
#define HAVE_movhi 1
#define HAVE_movqi 1
